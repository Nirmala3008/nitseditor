...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "login",
  beforeCreate: function beforeCreate() {// console.log('Working on Login page')
    // var body = document.body;
    //
    // body.classList.add("kt-header--fixed", "kt-header-mobile--fixed", "kt-subheader--fixed", "kt-subheader--enabled", "kt-subheader--solid", "kt-aside--enabled", "kt-aside--fixed", "kt-page--loading")
  },
  beforeDestroy: function beforeDestroy() {// console.log('Destroyed on Login page')
    // var body = document.body;
    //
    // body.classList.remove("kt-header--fixed", "kt-header-mobile--fixed", "kt-subheader--fixed", "kt-subheader--enabled", "kt-subheader--solid", "kt-aside--enabled", "kt-aside--fixed", "kt-page--loading")
  },
  methods: {
...
/* empty/unused harmony star reexport *//* harmony import */ var _Login_vue_vue_type_style_index_1_id_4964d332_lang_css_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Login.vue?vue&type=style&index=1&id=4964d332&lang=css&scoped=true& */ "./vendor/nitseditor/framework/src/Frontend/Admin/components/Pages/Login.vue?vue&type=style&index=1&id=4964d332&lang=css&scoped=true&");
