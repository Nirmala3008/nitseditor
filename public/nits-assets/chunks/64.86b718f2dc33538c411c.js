...
/***/ "./vendor/nitseditor/framework/src/Frontend/Admin/components/Elements/Portlets/_nits_portlet.js":
/*!******************************************************************************************************!*\
  !*** ./vendor/nitseditor/framework/src/Frontend/Admin/components/Elements/Portlets/_nits_portlet.js ***!
  \******************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  render: function render(createElement) {
    ...
    var headerActionIcons = '';

    if (this.headActions) {
      switch (this.actionType) {
        case 'icons':
          headerActionIcons = createElement('div', {
            "class": 'm-portlet__head-tools'
          }, [createElement('ul', {
            "class": 'm-portlet__nav'
          }, this.headActions.map(function (a) {
        ...
        case 'toolbar-background':
          headerActionIcons = createElement('div', {
            ...
            "class": 'btn-group m-btn-group m-btn-group--pill',
            attrs: {
              role: 'group',
              'aria-label': '...'
            }
    ...
    if (this.footer) {
      var footerText = createElement('div', {
        "class": 'col-lg-6 m--valign-middle'
      }, 'Portlet footer text');
      var footerActionButton = createElement('div', {
        "class": 'col-lg-6 m--align-right'
      }, [createElement('button', {
        "class": 'btn btn-brand'
      }, 'Submit'), createElement('span', {
        "class": 'm--margin-left-10'
      }, ['or ', createElement('a', {
        "class": 'm-link m--font-bold'
      }, 'Cancel')])]);
      footerElement = createElement('div', {
        "class": 'm-portlet__foot'
      }, [createElement('div', {
    ...
    }, [element]), headerActionIcons]), createElement('div', {
    ...
    }, this.$slots.content)])]), footerElement]);
  }
});
